...
class NewsletterSignupDecorator extends DataObjectDecorator {
	...
	private $newsletterSignupBefore = null;

	function onBeforeWrite(){
		$this->newsletterSignupBefore = $this->dbObject("NewsletterSignup");
	}

}

function NewsletterSignupDecorator_Step extends OrderStep {
